...
export const fellowshipOpportunities: Opportunity[] = [
  {
    ...
    fullDescription:
      "Afore Grants support high‐agency builders (≤21 years old) in North America who want to explore bold ideas. Each recipient receives $1,000 in equity‐free funding, paired mentorship from an experienced founder and an investor, weekly office hours and talks, access to office space, and the option to join a demo day. Applications are reviewed on a rolling basis via a simple one‐question form :contentReference[oaicite:0]{index=0}.",
    openDate: null,
    closeDate: null,
    tags: ["grant", "microgrant", "non-dilutive", "under-21", "mentorship"],
    category: "grant",
    region: "North America",
    country: null,
    eligibility:
      "High‐agency builders aged 21 or younger based in North America; any project idea; no equity requirement; simple one‐question application followed by a short interview :contentReference[oaicite:1]{index=1}.",
  ...
  },
  {
    ...
    fullDescription:
      "The 776 Foundation Fellowship supports 20 exceptional individuals (18–24) for two years to work full-time on innovative solutions to climate change instead of pursuing a university degree. Fellows receive a $100,000 grant distributed quarterly, access to the 776 network and its operating system, Cerebro, and mentorship from industry experts. The 2025 cohort applications open on 2025-03-12 and close on 2025-04-14, with the fellowship beginning on 2025-06-23. :contentReference[oaicite:0]{index=0}",
    openDate: "2025-03-12",
    closeDate: "2025-04-14",
    tags: ["fellowship", "grant", "climate-change", "global", "early-career"],
    category: "fellowship",
    region: "Global",
    country: null,
    eligibility:
      "Applicants must be aged 18–24, globally located, with an original project addressing climate change, and able to commit full-time (skipping or pausing university) for two years :contentReference[oaicite:1]{index=1}.",
  ...
  },
  {
    ...
    fullDescription:
      "The Edge City Fellowship is a month-long in-person program empowering high-agency builders (under 25) to accelerate human flourishing across frontier tech, science & society. Fellows receive a full ride to one of Edge City’s popup villages (e.g. Edge Esmeralda in Healdsburg, CA, May 24 – June 21 2025; Edge City LatAm in Argentina later in the year), access to a global mentorship network, and opportunities for follow-on funding via Long Journey VC and internal grant programs :contentReference[oaicite:0]{index=0}.",
    openDate: null,
    closeDate: null,
    tags: [
      "fellowship",
    ...
    country: null,
    eligibility:
      "Curious, kind, high-agency builders under 25 with a strong proof-of-work portfolio; no formal education requirements :contentReference[oaicite:1]{index=1}.",
    applyLink:
  ...
  },
  {
    ...
    fullDescription:
      "For over 40 years, Ashoka has elected world-leading social entrepreneurs as Fellows. Selected changemakers join a lifelong, non-residential Fellowship—receiving an unrestricted, needs-assessed stipend (up to three years), pro-bono legal advice, coaching, leadership development, and access to online courses and trainings on systems change and social finance. Ashoka’s global community of peers provides personalized and ad hoc support throughout Fellows’ entrepreneurial journeys :contentReference[oaicite:0]{index=0}.",
    openDate: null,
    closeDate: null,
    tags: ["social-entrepreneurship", "stipend", "network", "systems-change"],
    category: "fellowship",
    region: "Global",
    country: null,
    eligibility:
      "Exceptional social entrepreneurs (founders/co-founders of non-profits) with proven, system-changing ideas, committed to working full-time on their initiative for at least three years :contentReference[oaicite:1]{index=1}.",
  ...
  },
  {
    ...
    fullDescription:
      "Entrepreneurs First (EF) is an international talent investor that backs exceptional individuals pre-team and pre-idea. Participants join a 12-week ‘FORM’ program to find cofounders and validate their startup concepts, then a 12-week ‘LAUNCH’ in San Francisco culminating in Demo Day. Fellows receive a living stipend, equity-free grant, bespoke cofounder matching, office space, and hands-on support to build and scale their companies :contentReference[oaicite:0]{index=0}.",
    openDate: "2025-06-29",
    closeDate: "2025-08-01",
    tags: ["talent-investor", "pre-team", "cofounding", "in-person"],
    category: "accelerator",
    region: "Global",
    country: null,
    eligibility:
      "Exceptional individuals (solo or small teams) with high potential to found tech startups; no prior idea or cofounder required :contentReference[oaicite:1]{index=1}.",
  ...
  },
  {
    ...
    openDate: null,
    closeDate: null,
    tags: ["pre-seed", "mentor-network", "startup", "entrepreneurship"],
    category: "accelerator",
    region: "North America",
    country: "USA",
    eligibility:
  ...
  },
  {
    ...
    openDate: null,
    closeDate: null,
    tags: ["fellowship", "research", "grant", "innovation", "community"],
    category: "fellowship",
    region: "Global",
    country: null,
    eligibility:
  ...
  },
  {
    ...
    tags: ["seed-funding", "startup", "mentorship", "network"],
    category: "accelerator",
    region: "North America",
  ...
  },
  {
    ...
    openDate: null,
    closeDate: null,
    tags: ["mentorship", "stipend", "silicon-valley", "startup"],
    category: "fellowship",
    region: "Global",
    country: null,
    eligibility:
